  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <center><h1 class="modal-title fs-5" id="exampleModalLabel">Agregar Producto</h1></center>
      ...
      <div class="container-fluid">
			<form method="POST" action="agregar.php" enctype="multipart/form-data"/ >
                ...
                <div class="row form-group m-2">
					...
					<div class="col-sm-10">
						<textarea type="text" class="form-control" name="descripcion" id="descripcion" rows="3" ></textarea>
					</div>
				</div>
                ...
                <div class="row form-group m-2">
                    <label for="formFile" class="form-label">Cargar Imagen ( .jpg, .png )</label>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="add" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk" value="subir"></span>Agregar</a>
      </div>
      </form>
    </div>
  </div>
